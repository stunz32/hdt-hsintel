...
namespace HSIntel.Engine.Models
{
    ...
    public sealed class GameAction
    {
        ...
        public HeroState? HeroAttacker { get; }
        ...
        public GameAction WithTarget(ActionTarget target)
        {
            ...
            return new GameAction(ActionType, Description, Priority, Card, Attacker, target, RequiresTarget, HeroAttacker);
        }
